...
# 辞書をtxtファイルに書き出し
save_dictionaries_to_txt(katakana_to_hiragana_dict, English_to_hiragana_dict, "pokemonBerryIMEDictHira2Kata.txt", "pokemonBerryIMEDictHira2Eng.txt")

# 辞書をplistファイルに書き出し
save_dictionaries_to_plist(katakana_to_hiragana_dict, English_to_hiragana_dict, "pokemonBerryIMEDictHira2Kata.plist", "pokemonBerryIMEDictHira2Eng.plist")
