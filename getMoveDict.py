...
# 辞書をtxtファイルに書き出し
save_dictionaries_to_txt(katakana_to_hiragana_dict, English_to_hiragana_dict, "pokemonMoveIMEDictHira2Kata.txt", "pokemonMoveIMEDictHira2Eng.txt")

# 辞書をplistファイルに書き出し
save_dictionaries_to_plist(katakana_to_hiragana_dict, English_to_hiragana_dict, "pokemonMoveIMEDictHira2Kata.plist", "pokemonMoveIMEDictHira2Eng.plist")
