...
# 辞書をtxtファイルに書き出し
save_dictionaries_to_txt(katakana_to_hiragana_dict, English_to_hiragana_dict, "pokemonItemIMEDictHira2Kata.txt", "pokemonItemIMEDictHira2Eng.txt")

# 辞書をplistファイルに書き出し
save_dictionaries_to_plist(katakana_to_hiragana_dict, English_to_hiragana_dict, "pokemonItemIMEDictHira2Kata.plist", "pokemonItemIMEDictHira2Eng.plist")
