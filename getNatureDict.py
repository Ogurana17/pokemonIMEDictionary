...
write_dictionary_to_file("txt", katakana_to_hiragana_dict, "Nature", "Nature/pokemonNatureIMEDictHira2Kata.txt")
write_dictionary_to_file("txt", English_to_hiragana_dict, "Nature", "Nature/pokemonNatureIMEDictHira2Eng.txt")
write_dictionary_to_file("plist", katakana_to_hiragana_dict, "Nature", "Nature/pokemonNatureIMEDictHira2Kata.plist")
write_dictionary_to_file("plist", English_to_hiragana_dict, "Nature", "Nature/pokemonNatureIMEDictHira2Eng.plist")
